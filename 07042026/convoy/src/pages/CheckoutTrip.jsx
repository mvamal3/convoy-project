...
const CheckoutTrip = () => {
  ...
  useEffect(() => {
    const fetchConveys = async () => {
      ...
      try {
        ...
        console.error("Failed to fetch conveys:", error);
        setConveyList([]);
      }
    };
  ...
  const handleStartCheckout = async () => {
    if (!selectedConveyId) {
      toast({
        title: "Select Convey",
        description: "Please select a convey to start checkout",
        variant: "destructive",
      });
      return;
    }
