...
const ConveyWiseReport = () => {
  ...
  const convoyUp = [
    { id: 1, label: "06:00 First Convey" },
    { id: 2, label: "09:00 Second Convey" },
    { id: 3, label: "12:00 Third Convey" },
    { id: 4, label: "14:30 Fourth Convey" },
  ];

  const convoyDown = [
    { id: 5, label: "06:30 First Convey" },
    { id: 6, label: "09:30 Second Convey" },
    { id: 7, label: "12:30 Third Convey" },
    { id: 8, label: "15:00 Fourth Convey" },
  ];
        ...
        <table className="min-w-[800px] w-full text-sm text-left text-gray-700 border">
          <thead className="bg-gray-100 text-xs uppercase">
            <tr>
              ...
              <th className="px-4 py-2 border">Convey</th>
