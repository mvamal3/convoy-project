...
const AllCheckoutTrips = () => {
  ...
  const conveyList =
    user?.checkpostid === 1
      ? [
          { id: 5, name: "First Convey", time: "06:30:00" },
          { id: 6, name: "Second Convey", time: "09:30:00" },
          { id: 7, name: "Third Convey", time: "12:30:00" },
          { id: 8, name: "Fourth Convey", time: "15:00:00" },
        ]
      : [
          { id: 1, name: "First Convey", time: "06:00:00" },
          { id: 2, name: "Second Convey", time: "09:00:00" },
          { id: 3, name: "Third Convey", time: "12:00:00" },
          { id: 4, name: "Fourth Convey", time: "14:30:00" },
        ];
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6">
              ...
              <div className="w-full sm:w-1/4">
                ...
                <select
                  ...
                  className="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring focus:border-blue-500"
                >
                  <option value="">All Conveys</option>
                ...
                <table className="min-w-[900px] w-full text-sm text-left text-gray-700 border">
                  <thead className="bg-gray-100 text-xs uppercase">
                    <tr>
                      ...
                      <th className="px-4 py-2 border">Approve Convey</th>
